            ...
            <table class='min-w-full text-sm text-gray-700'>
                <thead class='bg-gray-200 text-gray-800 uppercase text-xs font-semibold border-b border-gray-300'>
                    <tr>
                        ...
                        <th class='px-6 py-3 text-center'>Justificado</th>
...
if ($teacher) {
    ...
    echo "<tr class='border-b border-gray-200 hover:bg-gray-50'>
            <td class='px-6 py-3 font-medium'>{$teacher['first_name']} {$teacher['last_name']}</td>
            <td class='px-6 py-3 text-center'>Profesor</td>
            <td class='px-6 py-3 text-center'>{$statusSelect}</td>
            ...
            <td class='px-6 py-3 text-center'>{$fileInput}</td>
            <td class='px-6 py-3 text-center'>{$date}</td>
          </tr>";
}
...
foreach ($students as $i => $r) {
    ...
    echo "<tr class='{$rowClass} border-b border-gray-200 hover:bg-gray-50'>
            <td class='px-6 py-3 font-medium'>{$r['first_name']} {$r['last_name']}</td>
            <td class='px-6 py-3 text-center'>Alumno</td>
            <td class='px-6 py-3 text-center'>{$statusSelect}</td>
            <td class='px-6 py-3 text-center'>
...
echo "      </tbody>
        ...
        <div class='mt-6 flex justify-end'>
            <button type='button' id='saveAttendanceBtn'
                class='bg-blue-700 text-white font-medium px-6 py-2 rounded-md shadow-sm hover:bg-blue-800 transition'>
