...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2025 a las 13:04:40
...
(3, '7To TP', 'Los excelentísimos estudiantes de séptimo TP', 'Tecnico En Programacion'),
(4, '1Ro Primera', '', ''),
(6, '1Ro Segunda', '', ''),
(7, '1Ro Tercera', '', ''),
(9, '2Do Primera', '', ''),
...
(12, '3Ro Segunda', '', ''),
(13, '3Ro Tercera', '', ''),
(14, '4To MMO', '', 'Maestro Mayor de Obra'),
(15, '4To TP', '', 'Tecnico En Programacion'),
(16, '5To TP', '', 'Tecnico En Programacion'),
(17, '5To MMO', '', 'Maestro Mayor de Obra'),
(18, '6To TP', '', 'Tecnico En Programacion'),
(19, '6To MMO', '', 'Maestro Mayor de Obra'),
(20, '7To MMO', '', 'Maestro Mayor de Obra');
...
--
-- Estructura de tabla para la tabla `subject_courses`
--
...
--
-- Volcado de datos para la tabla `subject_courses`
--
...
--
-- Indices de la tabla `subject_courses`
--
ALTER TABLE `subject_courses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `subject_id` (`subject_id`,`course_id`),
...
--
-- AUTO_INCREMENT de la tabla `subject_courses`
--
ALTER TABLE `subject_courses`
...
--
-- Filtros para la tabla `subject_courses`
--
ALTER TABLE `subject_courses`
