        ...
        <tbody>
          ...
          try {
              ...
              if ($teachers) {
                  ...
                  echo "<tr><td colspan='5' class='px-4 md:px-6 py-4 text-center text-gray-500'>No hay docentes registrados</td></tr>";
              }
