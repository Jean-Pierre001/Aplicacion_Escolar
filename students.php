      ...
      <table class="min-w-full border-collapse">
        <thead class="bg-gradient-to-r from-blue-500 to-blue-700 text-white">
          <tr>
            ...
            <th class="px-4 md:px-6 py-3 border-r border-gray-300 text-left font-medium uppercase">DNI</th>
          ...
          try {
              ...
              if ($students) {
                  foreach ($students as $i => $student) {
                      ...
                      echo "<td class='px-4 md:px-6 py-4 border-r border-gray-300'>{$student['student_id']}</td>";
                      echo "<td class='px-4 md:px-6 py-4 border-r border-gray-300'>{$student['last_name']}</td>";
                      echo "<td class='px-4 md:px-6 py-4 border-r border-gray-300'>{$student['first_name']}</td>";
                      echo "<td class='px-4 md:px-6 py-4 border-r border-gray-300'>{$student['DNI']}</td>";
                      echo "<td class='px-4 md:px-6 py-4 border-r border-gray-300'>{$student['course_name']}</td>";
                      ...
                      echo "<a href='students_back/delete_student.php?id={$student['student_id']}' 
                  ...
                  echo "<tr><td colspan='6' class='px-4 md:px-6 py-4 text-center text-gray-500'>No hay estudiantes registrados</td></tr>";
              }
