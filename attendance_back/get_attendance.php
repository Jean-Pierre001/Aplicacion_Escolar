...
<tr><th class="px-6 py-3">ID</th><th class="px-6 py-3">Nombre</th><th class="px-6 py-3">Apellido</th><th class="px-6 py-3">Presente</th></tr></thead>';
echo '<tbody>';
foreach ($students as $student) {
    ...
    echo "<td class='px-6 py-4 text-center'><input type='checkbox' /></td>";
    echo "</tr>";
}
echo '</tbody></table>';
